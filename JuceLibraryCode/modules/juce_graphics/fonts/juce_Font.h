...
public:
    ...
    */
    ...
    //==============================================================================
    /** Creates a sans-serif font in a given size using legacy interface.
    ...
    */
    ...
    /** Creates a font with a given typeface and parameters using legacy interface.
    ...
    */
    ...
    //==============================================================================
    /** Returns the font's legacy style flags.
    ...
    */
    ...
    /** Returns a copy of this font with the given set of legacy style flags.
    ...
    */
    ...
    //==============================================================================
    /** Changes all the font's characteristics with one call using legacy interface. */
